...
class categoryDeleteDirective extends SchemaDirectiveVisitor {
    ...
    field.resolve = async function (...args) {
      ...
      if (!authorized)
        throw new UserInputError(
          'Sorry!!!. You are not authorized to delete category'
        )
...
export default categoryDeleteDirective
