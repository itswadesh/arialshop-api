...
class brandSaveDirective extends SchemaDirectiveVisitor {
    ...
    field.resolve = async function (...args) {
      ...
      if (!authorized)
        throw new UserInputError(
          'Sorry!!!. You are not authorized to create or update brand'
        )
...
export default brandSaveDirective
